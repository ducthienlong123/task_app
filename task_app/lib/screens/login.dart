      ...
      body: Container(
        child: Column(
          children: [
            ...
            //khi nhấn nút quên mật khẩu thì chuyển hướng đến trang quên mật khẩu
            GestureDetector(
              onTap: () {
            ...
            //khi nhấn nút đăng nhập bằng google thì đăng nhập bằng google
            Row(
              ...
              children: [
                ...
                //   width: 30.0,
                // ),
                //khi nhấn nút đăng nhập bằng facebook thì đăng nhập bằng facebook
                // GestureDetector(
                //   onTap: () {
